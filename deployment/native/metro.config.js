...
const metroConfig = {
    watchFolders: [
        path.resolve(__dirname, "Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/rich-text-web/tests/testProject/theme"),
        path.resolve(__dirname, "Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/rich-text-web/tests/testProject/javascriptsource"),
        path.resolve(__dirname, "Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/rich-text-web/tests/testProject/themesource"),
        path.resolve(__dirname, "Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/rich-text-web/tests/testProject/.mendix-cache/modules"),
