...
const metroConfig = {
    projectRoot,
    watchFolders: [
        safeRealpathSync("Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/badge-web/tests/testProject/theme"),
        safeRealpathSync("Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/badge-web/tests/testProject/javascriptsource"),
        safeRealpathSync("Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/badge-web/tests/testProject/themesource"),
        safeRealpathSync("Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/badge-web/tests/testProject/.mendix-cache/modules"),
        modelerNodeRoot,
    ],
    resolver: {
        useWatchman: false,
