define(['react', 'react-dom'], (function (React, reactDom) { 'use strict';
    ...
    function withPreloader(Component, isLoading) {
      return function Preloader(props) {
        const isLoaded = React.useRef(false).current ||= !isLoading(props);
        return isLoaded ? React.createElement(Component, {
          ...props
    ...
    function useObserver$1(render, baseComponentName) {
      ...
      var admRef = React__default["default"].useRef(null);
      if (!admRef.current) {
        // First render
        var adm_1 = {
          reaction: null,
      ...
      React__default["default"].useDebugValue(adm.reaction, printDebugValue$1);
    ...
    var ReactForwardRefSymbol$1 = hasSymbol$1 ? Symbol.for("react.forward_ref") : typeof React.forwardRef === "function" && React.forwardRef(function (props) {
      return null;
    })["$$typeof"];
    var ReactMemoSymbol$1 = hasSymbol$1 ? Symbol.for("react.memo") : typeof React.memo === "function" && React.memo(function (props) {
      return null;
    })["$$typeof"];
    ...
    var _a$2;
    observerBatching$1(reactDom.unstable_batchedUpdates);
    ...
    */
    ...
    function usePositionObserver$1(target, active) {
      const [position, setPosition] = React.useState();
      const onAnimationFrameHandler = React.useCallback(() => {
        setPosition(prev => {
          const next = target?.getBoundingClientRect();
          if (shouldUpdatePosition$1(prev, next)) {
            return next;
          }
          return prev;
        });
      }, [target]);
      useAnimationFrameEffect$1(active ? onAnimationFrameHandler : undefined);
      return position;
    }
    function useAnimationFrameEffect$1(callback) {
      React.useEffect(() => callback ? animationLoop$1(callback) : undefined, [callback]);
    }
    function shouldUpdatePosition$1(a, b) {
      return !a || !b || a.height !== b.height || a.width !== b.width || a.bottom !== b.bottom || a.top !== b.top || a.left !== b.left || a.right !== b.right;
    }
    function animationLoop$1(callback) {
      let requestId;
      const requestFrame = () => {
    ...
    function FilterSelector(props) {
      ...
      const filterSelectorsRef = React.useRef(null);
      useOnClickOutside$1([componentRef, filterSelectorsRef], () => setShow(false));
      const position = usePositionObserver$1(componentRef.current, show);
      const onClick = React.useCallback(value => {
        onChange(value);
        setShow(false);
      }, [onChange]);
      const filterSelectors = React.createElement("ul", {
    ...
    function useOnClickOutside$1(ref, handler) {
      React.useEffect(() => {
    ...
    observer$1(function InputWithFilters(props) {
      const {
        inputStores: [input1]
      } = props;
      return React.createElement("div", {
        ...
        style: props.styles
      }, props.badge ? React.createElement(Badge, {
        style: {
          left: 40
        }
      }, props.badge) : null, props.adjustable && React.createElement(FilterSelector, {
    ...
    function useAnimationFrameEffect(callback) {
      React.useEffect(() => callback ? animationLoop(callback) : undefined, [callback]);
    }
    ...
    function FilterContentComponent(props) {
      const {
        footer,
        id,
        options,
      ...
      const optionsList = hasOptions ? React.createElement("ul", {
        id: `${id}-dropdown-list`,
        ...
        className: "filter-label"
      }, props.empty.caption)), options.map((option, index) => React.createElement("li", {
        className: classNames({
        ...
        role: "menuitem",
        tabIndex: 0
      }, multiSelect ? React.createElement(React.Fragment, null, React.createElement("input", {
        id: `${id}_checkbox_toggle_${index}`,
        type: "checkbox",
        checked: option.selected,
        onChange: preventReactErrorsAboutReadOnly$1
      }), React.createElement("label", {
        htmlFor: `${id}_checkbox_toggle_${index}`,
        style: {
          pointerEvents: "none"
        }
      }, option.caption)) : React.createElement("div", {
        className: "filter-label"
      }, option.caption)))) : null;
      return React.createElement("div", {
    ...
    function preventReactErrorsAboutReadOnly$1() {
      return undefined;
    }
    ...
    function preventReactErrorsAboutReadOnly() {
      return undefined;
    }
    ...
    function Select(props) {
      ...
      const containerClick = React.useCallback(() => {
        setShow(show => !show);
        setTimeout(() => {
          optionsRef.current?.querySelector('[role="menuitem"]')?.focus();
        }, 10);
        if (onTriggerClick) {
          onTriggerClick();
        }
      ...
      return React.createElement("div", {
        ...
        ref: componentRef,
        style: styles
      }, props.badge ? React.createElement(Badge, null, props.badge) : null, React.createElement(FormControlComponent, {
        ariaLabel: ariaLabel,
        status: status,
        id: id,
      ...
      }), show ? React.createElement(FilterContentComponent, {
        position: position,
        footer: footer,
        id: id,
        options: options,
    ...
    function useObserver(render, baseComponentName) {
      ...
      React__default["default"].useDebugValue(adm.reaction, printDebugValue);
      React__default["default"].useSyncExternalStore(
      // Both of these must be stable, otherwise it would keep resubscribing every render.
      adm.subscribe, adm.getSnapshot, adm.getSnapshot);
      // render the original component, but have the
    ...
    function withCustomOptionsGuard(Component) {
        return function CustomOptionsGuard(props) {
            const [error] = React.useState(() => {
                var _a;
                for (const opt of props.filterOptions) {
                    const value = `${(_a = opt.value) === null || _a === void 0 ? void 0 : _a.value}`;
            ...
            if (error) {
                return React.createElement(Alert, { bootstrapStyle: "danger" }, error.message);
            }
    ...
    function Container$2(props) {
        var _a;
        var _b;
        const id = ((_a = (_b = React.useRef()).current) !== null && _a !== void 0 ? _a : (_b.current = `Dropdown${generateUUID()}`));
        const [controller] = React.useState(() => new StaticFilterController(props));
        React.useEffect(() => controller.setup(), [controller]);
        return (React.createElement(Select, { options: controller.options, empty: controller.empty, onSelect: controller.onSelect, multiSelect: controller.multiselect, inputValue: controller.inputValue, id: id, ariaLabel: props.ariaLabel, className: props.className, tabIndex: props.tabIndex, placeholder: controller.empty.caption, styles: props.styles }));
    }
    const StaticFilterContainer = withCustomOptionsGuard(observer(Container$2));
    ...
    function getGlobalFilterContextObject() {
      return window[CONTEXT_OBJECT_PATH] ??= React.createContext(null);
    }
    ...
    function useSelectFilterAPI(key) {
      const ctx = useFilterContextValue();
      const slctAPI = React.useRef();
      if (ctx.hasError) {
      ...
      return value(slctAPI.current ??= {
        filterStore: store,
        parentChannelName: api.parentChannelName
      });
    }

    function withSelectFilterAPI(Component) {
        return function FilterAPIProvider(props) {
            const api = useSelectFilterAPI(props.groupKey);
            if (api.hasError) {
                return React.createElement(Alert, { bootstrapStyle: "danger" }, api.error.message);
            }
            return React.createElement(Component, { ...props, filterStore: api.value.filterStore });
        };
    }

    class RefFilterController {
      constructor(params) {
        _defineProperty(this, "store", void 0);
        _defineProperty(this, "isDataFetched", false);
        _defineProperty(this, "empty", void 0);
        _defineProperty(this, "multiselect", false);
        _defineProperty(this, "onChange", void 0);
    ...
    function useOnScrollBottom(cb, options = {}) {
      const {
        triggerZoneHeight = 0
      } = options;
      const onScrollParams = React.useRef({
        callback: cb,
      ...
      const onScroll = React.useCallback(event => {
        ...
        const isDeadZoneNow = Math.floor(scrollHeight - event.currentTarget.scrollTop) <= Math.floor(event.currentTarget.clientHeight);
    ...
    function Container$1(props) {
        ...
        var _b;
        const id = ((_a = (_b = React.useRef()).current) !== null && _a !== void 0 ? _a : (_b.current = `Dropdown${generateUUID()}`));
        const [controller] = React.useState(() => new RefFilterController({
        ...
        return (React.createElement(Select, { options: controller.options, empty: controller.empty, onSelect: controller.handleSelect, multiSelect: controller.multiselect, inputValue: controller.inputValue, onTriggerClick: controller.handleTriggerClick, onContentScroll: handleContentScroll, id: id, ariaLabel: props.ariaLabel, className: props.className, tabIndex: props.tabIndex, styles: props.styles }));
    }
    const RefFilterContainer = observer(Container$1);

    function Container(props) {
        var _a, _b, _c, _d;
        const commonProps = {
            ariaLabel: (_a = props.ariaLabel) === null || _a === void 0 ? void 0 : _a.value,
        ...
        if (props.filterStore.type === "refselect") {
            return (React.createElement(RefFilterContainer, { ...commonProps, filterStore: props.filterStore, multiselect: props.multiSelect, emptyCaption: (_b = props.emptyOptionCaption) === null || _b === void 0 ? void 0 : _b.value }));
        }
        return (React.createElement(StaticFilterContainer, { ...commonProps, filterStore: props.filterStore, filterOptions: props.filterOptions, multiselect: props.multiSelect, defaultValue: (_c = props.defaultValue) === null || _c === void 0 ? void 0 : _c.value, emptyCaption: (_d = props.emptyOptionCaption) === null || _d === void 0 ? void 0 : _d.value }));
    }
    const container = withPreloader(Container, props => { var _a; return ((_a = props.defaultValue) === null || _a === void 0 ? void 0 : _a.status) === "loading"; });
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
