define(['exports', 'react/jsx-runtime', 'react', 'react-dom'], (function (exports, jsxRuntime, React, reactDom) { 'use strict';

    function useConst(fn) {
      return React.useRef(null).current ??= typeof fn === "function" ? fn() : fn;
    }
    ...
    */
    ...
    const Alert = ({
      ...
      role,
      id
    }) => React.Children.count(children) > 0 ? jsxRuntime.jsx("div", {
    ...
    function getGlobalSortContext({
      ...
      return scope[SORT_PATH] ??= React.createContext(null);
    }
    function useSortAPI(options = {
      isPreview: false
    }) {
      const api = React.useContext(getGlobalSortContext(options));
      if (api === null) {
    ...
    function withSortAPI(Component) {
      ...
      function SortAPIInjector(props) {
        ...
        return React.createElement(SortAPIGuard, {
          ...props,
          sortAPI: sortAPI.value
        });
      }
      return function (props) {
        return React.createElement(ErrorBoundary, null, React.createElement(SortAPIInjector, {
          ...props
        }));
      };
    }
    ...
    function SortComponent(props) {
        ...
        const optionsComponent = reactDom.createPortal(jsxRuntime.jsx("ul", { ref: optionsRef, id: `${props.id}-dropdown-list`, className: "dropdown-list", role: "menu", "data-focusindex": 0, style: { position: "fixed", width: dropdownWidth, top: position?.bottom, left: position?.left }, children: props.options.map((option, index) => (jsxRuntime.jsx("li", { className: classNames({
                ...
                }, role: "menuitem", tabIndex: 0, children: jsxRuntime.jsx("div", { className: "filter-label", children: option.caption }) }, index))) }), document.body);
        ...
        return (jsxRuntime.jsxs("div", { className: classNames("dropdown-container", props.className), "data-focusindex": props.tabIndex ?? 0, ref: componentRef, style: props.styles, children: [jsxRuntime.jsxs("div", { className: "dropdown-triggerer-wrapper", children: [jsxRuntime.jsx("input", { value: props.value ? selected?.caption : "", placeholder: props.placeholder, className: "form-control dropdown-triggerer", onClick: containerClick, onKeyDown: e => {
                                if (e.key === "Enter" || e.key === " ") {
                                    e.preventDefault();
                                    e.stopPropagation();
                                    containerClick();
                            ...
                            }, "aria-expanded": show, "aria-controls": `${props.id}-dropdown-list`, "aria-label": props.screenReaderInputCaption, onChange: () => { } }), jsxRuntime.jsx("button", { "aria-label": props.screenReaderButtonCaption, className: classNames("btn btn-default btn-sort", {
    ...
    function Container(props) {
        ...
        return (jsxRuntime.jsx(SortComponent, { className: props.class, placeholder: props.emptyOptionCaption?.value, id: id, screenReaderButtonCaption: props.screenReaderButtonCaption?.value, screenReaderInputCaption: props.screenReaderInputCaption?.value, styles: props.style, tabIndex: props.tabIndex, ...sortProps }));
    }
