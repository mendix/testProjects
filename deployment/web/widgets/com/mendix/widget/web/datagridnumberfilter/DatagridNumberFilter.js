define(['react', 'react-dom', 'mendix/filters/builders', 'big.js'], (function (React, reactDom, builders, big_js) { 'use strict';
    ...
    */
    ...
    function Container(props) {
        var _a, _b, _c, _d, _e;
        var _f;
        const id = ((_a = (_f = React.useRef()).current) !== null && _a !== void 0 ? _a : (_f.current = `NumberFilter${generateUUID()}`));
