define(['exports', 'react/jsx-runtime', 'react', 'react-dom'], (function (exports, jsxRuntime, React, reactDom) { 'use strict';
	...
	*/
	...
	function getGlobalSelectionContext() {
	  return window[CONTEXT_OBJECT_PATH] ??= React.createContext(undefined);
	}
	...
	function SelectionHelperComponent(props) {
	    ...
	    return (jsxRuntime.jsx("div", { className: `widget-selection-helper ${props.className}`, style: props.cssStyles, children: props.type === "custom" ? (jsxRuntime.jsx("div", { className: "selection-helper-custom", onClick: props.onClick, onKeyDown: e => {
	                if (e.key === "Enter" || e.key === " ") {
	                    e.preventDefault();
	                    props.onClick?.();
	                }
	            }, children: props.children })) : (jsxRuntime.jsxs("div", { className: "selection-helper-checkbox mx-checkbox form-group label-after", children: [jsxRuntime.jsx(ThreeStateCheckBox, { id: id, value: props.status, onChange: props.onClick }), jsxRuntime.jsx("label", { htmlFor: id, className: "control-label", children: props.children })] })) }));
	}
