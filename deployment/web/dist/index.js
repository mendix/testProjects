export const __rspack_esm_id = "index";
export const __rspack_esm_ids = ["index"];
export const __webpack_modules__ = {
"\\\\Mac\\Home\\Documents\\Projects\\web-widgets\\packages\\pluggableWidgets\\badge-web\\tests\\testProject\\deployment\\web\\index.js"(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
(0,mendix__rspack_import_0.startApp)({
    "languages": [
        "en_US",
        "nl_NL"
    ],
    "systemTexts": {
        ...
        "mendix.lib.Validations.invalid_attribute": [
            ...
            "De waarde '{1}' is niet geldig voor het veld {2}."
        ],
        ...
        "mendix.signin.http403": [
            ...
            "U hebt niet genoeg rechten om deze pagina te openen. U kunt proberen aan te melden als een andere gebruiker."
        ],
        "mxui.common.true": [
            "Yes",
            "Ja"
        ...
        "mxui.widget.DataGrid.no_selection": [
            ...
            "Geen selectie beschikbaar."
        ],
        "mxui.widget.DataGrid.confirm_delete": [
            "Delete {1} items?",
            "Wilt u {1} regel(s) verwijderen?"
        ],
        ...
        "mxui.widget.DataGrid.waitForSearch": [
            ...
            "Vul alstublieft één of meer zoekcriteria in."
        ],
        ...
        "mxui.widget.FileInput.incorrect_extension": [
            ...
            "U kunt hier alleen bestanden van de volgende types uploaden: {1}."
        ],
        ...
        "mxui.widget.SelectBox.itemsSelected": [
            "{1} items selected",
            "{1} items geselecteerd"
        ],
        "mxui.sys.UI.sync_error": [
            "Your changes cannot be synchronized at this moment. They will be synchronized later.",
            "Uw wijzigingen kunnen niet worden gesynchroniseerd op dit moment. Ze zullen later worden gesynchroniseerd."
        ],
        ...
        "mxui.widget.DialogMessage.file_download_message": [
            ...
            "Weet u zeker dat u dit bestand wilt downloaden?"
        ],
        ...
        "mxui.sys.UI.simultaneous_sync_error": [
            ...
            "Het uitvoeren van gelijktijdige synchronisaties wordt niet ondersteund. Probeer het alstublieft nogmaals nadat de huidige synchronisatie is voltooid."
        ],
        ...
        "mxui.sys.UI.page_not_found": [
            ...
            "Deze pagina kon niet gevonden worden. U word doorverwezen naar de home page"
        ],
        "mxui.sys.UI.background_synchronization_error": [
            ...
            "Objecten die op dit moment worden gesynchroniseerd, kunnen niet worden gecommit. Wacht tot de synchronisatie is voltooid en probeer het dan opnieuw."
        ],
        "mxui.sys.UI.concurrent_data_modification": [
            ...
            "De gegevens die u probeert op te slaan zijn al door een andere gebruiker gewijzigd. Ververs de pagina en probeer het opnieuw."
        ]
    },
    "constants": {
...
import * as __rspack_chunk_2 from './index.js';
__webpack_require__.C(__rspack_chunk_2);
var __webpack_exports__ = __webpack_exec__("\\\\Mac\\Home\\Documents\\Projects\\web-widgets\\packages\\pluggableWidgets\\badge-web\\tests\\testProject\\deployment\\web\\index.js");