...
export default {
    ...
    plugins: [
        new rspack.experiments.VirtualModulesPlugin({
            "Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/gallery-web/tests/testProject/deployment/empty-module.js": `export default {};`,
        }),
        new NormalModuleReplacementPlugin(/react-native/, "Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/gallery-web/tests/testProject/deployment/empty-module.js"),
        new CopyRspackPlugin({
            patterns: [
                {
                    from: "Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/gallery-web/tests/testProject/deployment/web/widgets",
                ...
                {
                    context: "Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/gallery-web/tests/testProject/deployment/web/widgets",
                    from: "**/assets/**",
                    noErrorOnMissing: true,
                },
            ],
        ...
        new ServiceWorkerRspackPlugin({
            deploymentDir: "Z:/Documents/Projects/web-widgets/packages/pluggableWidgets/gallery-web/tests/testProject/deployment",
        }),
    ],
};
