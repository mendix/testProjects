...
import { ACT_OnClick } from "../nanoflows/MyFirstModule.ACT_OnClick.js";
                ...
                content={[
                    <$Div key={"p.MyFirstModule.Home_Web.layoutGrid1$row0$column0"}
                        ...
                        content={[
                            ...
                            <$Gallery key={"p.MyFirstModule.Home_Web.gallery1"}
                                ...
                                content={TemplatedWidgetProperty({
                                    ...
                                    "editable": false,
                                    "children": () => [
                                        <$Container key={"p.MyFirstModule.Home_Web.container2"}
                                            ...
                                            content={[
                                                <$Text key={"p.MyFirstModule.Home_Web.text3"}
                                                    ...
                                                    class={"mx-name-text3"}
                                                    caption={ExpressionProperty({
                                                        "expression": { "expr": { "type": "variable", "variable": "currentObject", "path": "FullName" }, "args": { "currentObject": { "widget": "p.MyFirstModule.Home_Web.gallery1", "source": "object" } } }
                                                    })}
                                                    renderMode={"p"} />,
                                                <$Text key={"p.MyFirstModule.Home_Web.text4"}
                                                    ...
                                                    class={"mx-name-text4"}
                                                    caption={ExpressionProperty({
                                                        "expression": { "expr": { "type": "function", "name": "_format", "parameters": [ { "type": "variable", "variable": "currentObject", "path": "Age" }, { "type": "literal", "value": "{\"decimalPrecision\":0}" } ] }, "args": { "currentObject": { "widget": "p.MyFirstModule.Home_Web.gallery1", "source": "object" } } }
                                                    })}
                                                    renderMode={"span"} />,
                                                <$Image key={"p.MyFirstModule.Home_Web.image1"}
                                            ...
                                            <$Div key={"p.MyFirstModule.Home_Web.layoutGrid3$row0"}
                                                ...
                                                content={[
                                                    <$Div key={"p.MyFirstModule.Home_Web.layoutGrid3$row0$column0"}
                                                        ...
                                                        class={"col-lg col-md col"}
                                                        content={[
                                                            <$DatagridTextFilter key={"p.MyFirstModule.Home_Web.textFilter1"}
                                                    ...
                                                    <$Div key={"p.MyFirstModule.Home_Web.layoutGrid3$row0$column1"}
                                                        $widgetId={"p.MyFirstModule.Home_Web.layoutGrid3$row0$column1"}
                                                        class={"col-lg col-md col"}
                                                        content={[
                                                            <$DatagridNumberFilter key={"p.MyFirstModule.Home_Web.numberFilter1"}
                                            ...
                                            <$Div key={"p.MyFirstModule.Home_Web.layoutGrid3$row1"}
                                                ...
                                                content={[
                                                    <$Div key={"p.MyFirstModule.Home_Web.layoutGrid3$row1$column0"}
                                                        ...
                                                        class={"col-lg col-md col"}
                                                        content={[
                                                            <$DatagridDropdownFilter key={"p.MyFirstModule.Home_Web.drop_downFilter1"}
                                                                ...
                                                                ariaLabel={ExpressionProperty({
                                                                    "expression": { "expr": { "type": "literal", "value": "Role filter" }, "args": {} }
                                                                })}
                                                                baseType={"attr"}
                                                                attrChoice={"linked"}
                                                    ...
                                                    <$Div key={"p.MyFirstModule.Home_Web.layoutGrid3$row1$column1"}
                                                        ...
                                                        class={"col-lg col-md col"}
                                                        content={[
                                                            <$DatagridDateFilter key={"p.MyFirstModule.Home_Web.dateFilter1"}
                                            ...
                                            <$Div key={"p.MyFirstModule.Home_Web.layoutGrid3$row2"}
                                                ...
                                                content={[
                                                    ...
                                                    <$Div key={"p.MyFirstModule.Home_Web.layoutGrid3$row2$column1"}
                                                        ...
                                                        class={"col-lg col-md col"}
                                                        content={[
                                                            <$DropdownSort key={"p.MyFirstModule.Home_Web.drop_downSort2"}
                                ...
                                filterSectionTitle={ExpressionProperty({
                                    "expression": { "expr": { "type": "literal", "value": "Header label" }, "args": {} }
                                })}
                                emptyMessageTitle={ExpressionProperty({
                                    "expression": { "expr": { "type": "literal", "value": "Empty section label" }, "args": {} }
                                })}
                                ariaLabelListBox={ExpressionProperty({
                                    "expression": { "expr": { "type": "literal", "value": "Gallery label" }, "args": {} }
                                })}
