...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key={"p.BootstrapBadge.Badge_NewEdit_3.layoutGrid1"}
        $widgetId={"p.BootstrapBadge.Badge_NewEdit_3.layoutGrid1"}
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        content={[
            <$Div key={"p.BootstrapBadge.Badge_NewEdit_3.layoutGrid1$row0"}
                $widgetId={"p.BootstrapBadge.Badge_NewEdit_3.layoutGrid1$row0"}
                class={"row"}
                content={[
                    <$Div key={"p.BootstrapBadge.Badge_NewEdit_3.layoutGrid1$row0$column0"}
                        $widgetId={"p.BootstrapBadge.Badge_NewEdit_3.layoutGrid1$row0$column0"}
                        class={"col-lg-12 col-md-12 col-12"}
                        content={[
                            <$DataView key={"p.BootstrapBadge.Badge_NewEdit_3.dataView1"}
                                ...
                                body={[
                                    <$FormGroup key={"p.BootstrapBadge.Badge_NewEdit_3.textBox6$formGroup"}
                                        $widgetId={"p.BootstrapBadge.Badge_NewEdit_3.textBox6$formGroup"}
                                        class={"mx-name-textBox6 mx-textbox"}
                                        control={[
                                            <$TextBox key={"p.BootstrapBadge.Badge_NewEdit_3.textBox6"}
                                    ...
                                    <$FormGroup key={"p.BootstrapBadge.Badge_NewEdit_3.textBox5$formGroup"}
                                        $widgetId={"p.BootstrapBadge.Badge_NewEdit_3.textBox5$formGroup"}
                                        class={"mx-name-textBox5 mx-textbox"}
                                        control={[
                                            <$TextBox key={"p.BootstrapBadge.Badge_NewEdit_3.textBox5"}
                                    ...
                                    <$FormGroup key={"p.BootstrapBadge.Badge_NewEdit_3.dropDown1$formGroup"}
                                        $widgetId={"p.BootstrapBadge.Badge_NewEdit_3.dropDown1$formGroup"}
                                        class={"mx-name-dropDown1"}
                                        control={[
                                            <$Combobox key={"p.BootstrapBadge.Badge_NewEdit_3.dropDown1"}
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ActionButton key={"p.BootstrapBadge.Badge_NewEdit_3.saveButton1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "saveChanges", "argMap": { "$object": { "widget": "p.BootstrapBadge.Badge_NewEdit_3.dataView1", "source": "object" } }, "config": { "operationId": "C/eczY2HTlqqFZm1QR75gw", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />,
                                    <$ActionButton key={"p.BootstrapBadge.Badge_NewEdit_3.cancelButton1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "Diu8F88wL1qfkWIRpaXOZw", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "s8AAEoaGJF2BD/djpVGLrw";
export const style = {};
