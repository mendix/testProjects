...
const { $Container, $Div, $Text, $ConditionalVisibilityWrapper, $ActionButton, $Gallery, $Image, $DatagridTextFilter, $DatagridNumberFilter, $DatagridDropdownFilter, $DatagridDateFilter, $DropdownSort } = asPluginWidgets({ Container, Div, Text, ConditionalVisibilityWrapper, ActionButton, Gallery, Image, DatagridTextFilter, DatagridNumberFilter, DatagridDropdownFilter, DatagridDateFilter, DropdownSort });

const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Container key={"p.MyFirstModule.Single_Selection.container1"}
        $widgetId={"p.MyFirstModule.Single_Selection.container1"}
        class={"mx-name-container1 pageheader"}
        renderMode={"div"}
        content={[
            <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid2"}
                $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid2"}
                class={"mx-name-layoutGrid2 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
                content={[
                    <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid2$row0"}
                        $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid2$row0"}
                        class={"row"}
                        content={[
                            <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid2$row0$column0"}
                                $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid2$row0$column0"}
                                class={"col-lg col-md col"}
                                content={[
                                    <$Text key={"p.MyFirstModule.Single_Selection.text1"}
                                        $widgetId={"p.MyFirstModule.Single_Selection.text1"}
                                        class={"mx-name-text1 pageheader-title spacing-outer-bottom"}
                                        caption={ExpressionProperty({
                                            "expression": { "expr": { "type": "literal", "value": "Single Selection" }, "args": {} }
                                        })}
                                        renderMode={"h3"} />
                                ]} />
                        ]} />
        ...
        ariaHidden={false} />,
    <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid1"}
        $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid1"}
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        content={[
            <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid1$row0"}
                $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid1$row0"}
                class={"row"}
                content={[
                    <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid1$row0$column0"}
                        $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid1$row0$column0"}
                        class={"col-lg col-md col"}
                        content={[
                            <$ConditionalVisibilityWrapper key={"p.MyFirstModule.Single_Selection.actionButton1$visibility"}
                                $widgetId={"p.MyFirstModule.Single_Selection.actionButton1$visibility"}
                                visible={ExpressionProperty({
                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" }, { "type": "literal", "value": "User" } ] }, "args": {} }
                                })}
                                contents={[
                                    <$ActionButton key={"p.MyFirstModule.Single_Selection.actionButton1"}
                                        $widgetId={"p.MyFirstModule.Single_Selection.actionButton1"}
                                        buttonId={"p.MyFirstModule.Single_Selection.actionButton1"}
                            ...
                            <$Gallery key={"p.MyFirstModule.Single_Selection.gallery1"}
                                $widgetId={"p.MyFirstModule.Single_Selection.gallery1"}
                                datasource={DatabaseObjectListProperty({
                                    "dataSourceId": "p.10",
                                    "entity": "MyFirstModule.GalleryItem",
                                    "operationId": "3C9pKsv7MV+OmhuYZDASBA",
                                    "sort": [
                                        [
                                            "FullName",
                                            "asc"
                                ...
                                content={TemplatedWidgetProperty({
                                    ...
                                    "editable": false,
                                    "children": () => [
                                        <$Container key={"p.MyFirstModule.Single_Selection.container2"}
                                            $widgetId={"p.MyFirstModule.Single_Selection.container2"}
                                            class={"mx-name-container2 col-center spacing-outer-top spacing-outer-bottom spacing-outer-left spacing-outer-right"}
                                            renderMode={"div"}
                                            content={[
                                                <$Text key={"p.MyFirstModule.Single_Selection.text3"}
                                                    $widgetId={"p.MyFirstModule.Single_Selection.text3"}
                                                    class={"mx-name-text3"}
                                                    caption={ExpressionProperty({
                                                        "expression": { "expr": { "type": "variable", "variable": "currentObject", "path": "FullName" }, "args": { "currentObject": { "widget": "p.MyFirstModule.Single_Selection.gallery1", "source": "object" } } }
                                                    })}
                                                    renderMode={"p"} />,
                                                <$Text key={"p.MyFirstModule.Single_Selection.text4"}
                                                    $widgetId={"p.MyFirstModule.Single_Selection.text4"}
                                                    class={"mx-name-text4"}
                                                    caption={ExpressionProperty({
                                                        "expression": { "expr": { "type": "function", "name": "_format", "parameters": [ { "type": "variable", "variable": "currentObject", "path": "Age" }, { "type": "literal", "value": "{\"decimalPrecision\":0}" } ] }, "args": { "currentObject": { "widget": "p.MyFirstModule.Single_Selection.gallery1", "source": "object" } } }
                                                    })}
                                                    renderMode={"span"} />,
                                                <$Image key={"p.MyFirstModule.Single_Selection.image1"}
                                                    $widgetId={"p.MyFirstModule.Single_Selection.image1"}
                                                    datasource={"image"}
                                                    imageObject={WebDynamicImageProperty({
                                                        "scope": "p.MyFirstModule.Single_Selection.gallery1",
                                ...
                                itemClass={ListExpressionProperty({
                                    "expression": { "expr": { "type": "conditional", "condition": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "currentObject", "path": "FullName" }, { "type": "literal", "value": "Isa" } ] }, "then": { "type": "literal", "value": "widget-gallery-column-span-2 aquamarine-background" }, "else": { "type": "conditional", "condition": { "type": "function", "name": "=", "parameters": [ { "type": "variable", "variable": "currentObject", "path": "FullName" }, { "type": "literal", "value": "Leo" } ] }, "then": { "type": "literal", "value": "widget-gallery-row-span-2 red-background" }, "else": { "type": "literal", "value": "" } } }, "args": { "currentObject": { "widget": "p.MyFirstModule.Single_Selection.gallery1", "source": "object" } } },
                                    "dataSourceId": "p.10"
                                })}
                                filtersPlaceholder={[
                                    <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid3"}
                                        $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid3"}
                                        class={"mx-name-layoutGrid3 mx-layoutgrid mx-layoutgrid-fluid"}
                                        content={[
                                            <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid3$row0"}
                                                $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid3$row0"}
                                                class={"row"}
                                                content={[
                                                    <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid3$row0$column0"}
                                                        $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid3$row0$column0"}
                                                        class={"col-lg col-md col"}
                                                        content={[
                                                            <$DatagridTextFilter key={"p.MyFirstModule.Single_Selection.textFilter1"}
                                                                $widgetId={"p.MyFirstModule.Single_Selection.textFilter1"}
                                                    ...
                                                    <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid3$row0$column1"}
                                                        $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid3$row0$column1"}
                                                        class={"col-lg col-md col"}
                                                        content={[
                                                            <$DatagridNumberFilter key={"p.MyFirstModule.Single_Selection.numberFilter1"}
                                                                $widgetId={"p.MyFirstModule.Single_Selection.numberFilter1"}
                                                                defaultFilter={"equal"}
                                                                placeholder={ExpressionProperty({
                                            ...
                                            <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid3$row1"}
                                                $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid3$row1"}
                                                class={"row"}
                                                content={[
                                                    <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid3$row1$column0"}
                                                        $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid3$row1$column0"}
                                                        class={"col-lg col-md col"}
                                                        content={[
                                                            <$DatagridDropdownFilter key={"p.MyFirstModule.Single_Selection.drop_downFilter1"}
                                                                $widgetId={"p.MyFirstModule.Single_Selection.drop_downFilter1"}
                                                                auto={false}
                                                                filterOptions={[
                                                                    {
                                                                        "caption": ExpressionProperty({
                                                    ...
                                                    <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid3$row1$column1"}
                                                        $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid3$row1$column1"}
                                                        class={"col-lg col-md col"}
                                                        content={[
                                                            <$DatagridDateFilter key={"p.MyFirstModule.Single_Selection.dateFilter1"}
                                                                $widgetId={"p.MyFirstModule.Single_Selection.dateFilter1"}
                                            ...
                                            <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid3$row2"}
                                                $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid3$row2"}
                                                class={"row"}
                                                content={[
                                                    <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid3$row2$column0"}
                                                        $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid3$row2$column0"}
                                                        class={"col-lg col-md col"} />,
                                                    <$Div key={"p.MyFirstModule.Single_Selection.layoutGrid3$row2$column1"}
                                                        $widgetId={"p.MyFirstModule.Single_Selection.layoutGrid3$row2$column1"}
                                                        class={"col-lg col-md col"}
                                                        content={[
                                                            <$DropdownSort key={"p.MyFirstModule.Single_Selection.drop_downSort2"}
                                                                $widgetId={"p.MyFirstModule.Single_Selection.drop_downSort2"}
                                                                emptyOptionCaption={ExpressionProperty({
                                ...
                                filterSectionTitle={ExpressionProperty({
                                    "expression": { "expr": { "type": "literal", "value": "Single 1" }, "args": {} }
                                })}
                                emptyMessageTitle={ExpressionProperty({
                                    "expression": { "expr": { "type": "literal", "value": "Single 2" }, "args": {} }
                                })}
                                ariaLabelListBox={ExpressionProperty({
                                    "expression": { "expr": { "type": "literal", "value": "Single 3" }, "args": {} }
                                })}
...
export const url = "/p/single-selection";
export const style = {};
