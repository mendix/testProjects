...
public class Country implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	 ...
	 */
	public static final java.lang.String entityName = "EmployeeDB.Country";
	 ...
	 */
	public static employeedb.proxies.Country initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new employeedb.proxies.Country(context, mendixObject);
	}

	public static employeedb.proxies.Country load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return employeedb.proxies.Country.initialize(context, mendixObject);
	}

	public static java.util.List<employeedb.proxies.Country> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> employeedb.proxies.Country.initialize(context, obj))
	...
	public boolean equals(Object obj)
	{
		...
		{
			final employeedb.proxies.Country that = (employeedb.proxies.Country) obj;
