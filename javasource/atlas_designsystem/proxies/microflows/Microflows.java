...
public class Microflows
{
	...
	public static void aSu_RestockPeopleEntities(IContext context)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		Core.microflowCall("Atlas_DesignSystem.ASu_RestockPeopleEntities").withParams(params).execute(context);
	}
