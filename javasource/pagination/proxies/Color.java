...
public class Color
{
	 ...
	 */
	public static final java.lang.String entityName = "Pagination.Color";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "Pagination.Color"));
	}
	...
	protected Color(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject colorMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("Pagination.Color", colorMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a Pagination.Color");
	...
	public static pagination.proxies.Color initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return pagination.proxies.Color.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static pagination.proxies.Color initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new pagination.proxies.Color(context, mendixObject);
	}

	public static pagination.proxies.Color load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return pagination.proxies.Color.initialize(context, mendixObject);
	}

	public static java.util.List<pagination.proxies.Color> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<pagination.proxies.Color> result = new java.util.ArrayList<pagination.proxies.Color>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//Pagination.Color" + xpathConstraint))
	...
	public boolean equals(Object obj)
	{
		...
		{
			final pagination.proxies.Color that = (pagination.proxies.Color) obj;
