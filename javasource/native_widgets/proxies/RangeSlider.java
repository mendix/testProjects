...
public class RangeSlider
{
	 ...
	 */
	public static final java.lang.String entityName = "Native_Widgets.RangeSlider";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "Native_Widgets.RangeSlider"));
	}
	...
	protected RangeSlider(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject rangeSliderMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("Native_Widgets.RangeSlider", rangeSliderMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a Native_Widgets.RangeSlider");
	...
	public static native_widgets.proxies.RangeSlider initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return native_widgets.proxies.RangeSlider.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static native_widgets.proxies.RangeSlider initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new native_widgets.proxies.RangeSlider(context, mendixObject);
	}

	public static native_widgets.proxies.RangeSlider load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return native_widgets.proxies.RangeSlider.initialize(context, mendixObject);
	}

	public static java.util.List<native_widgets.proxies.RangeSlider> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<native_widgets.proxies.RangeSlider> result = new java.util.ArrayList<native_widgets.proxies.RangeSlider>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//Native_Widgets.RangeSlider" + xpathConstraint))
			result.add(native_widgets.proxies.RangeSlider.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final native_widgets.proxies.RangeSlider that = (native_widgets.proxies.RangeSlider) obj;
	...
	{
		return "Native_Widgets.RangeSlider";
	}
