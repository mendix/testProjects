...
public class Image extends system.proxies.FileDocument
{
	...
	public static system.proxies.Image initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("Native_PageTemplates.Images", mendixObject.getType()))
			return native_pagetemplates.proxies.Images.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Native_PageTemplates.Images_Rounded_1x", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("Native_PageTemplates.People", mendixObject.getType()))
			return native_pagetemplates.proxies.People.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Native_Widgets.PopupMenu", mendixObject.getType()))
			return native_widgets.proxies.PopupMenu.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Native_BuildingBlocks.PopupMenu", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("Native_Widgets.User", mendixObject.getType()))
			return native_widgets.proxies.User.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("Native_BuildingBlocks.User", mendixObject.getType()))
