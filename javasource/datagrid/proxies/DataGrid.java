...
public class DataGrid
{
	...
	/**
	 * Set value of EnumerationAttribute
	 * @param enumerationattribute
	 */
	public final datagrid.proxies._DataGridEnumeration getEnumerationAttribute()
	{
		return getEnumerationAttribute(getContext());
	}

	/**
	 * @param context
	 * @return value of EnumerationAttribute
	 */
	public final datagrid.proxies._DataGridEnumeration getEnumerationAttribute(com.mendix.systemwideinterfaces.core.IContext context)
	{
		Object obj = getMendixObject().getValue(context, MemberNames.EnumerationAttribute.toString());
		if (obj == null)
			return null;

		return datagrid.proxies._DataGridEnumeration.valueOf((java.lang.String) obj);
	}
	 ...
	 * @param enumerationattribute
	 */
	public final void setEnumerationAttribute(datagrid.proxies._DataGridEnumeration enumerationattribute)
	{
		setEnumerationAttribute(getContext(), enumerationattribute);
	}
	 ...
	 * @param enumerationattribute
	 */
	public final void setEnumerationAttribute(com.mendix.systemwideinterfaces.core.IContext context, datagrid.proxies._DataGridEnumeration enumerationattribute)
	{
		if (enumerationattribute != null)
			getMendixObject().setValue(context, MemberNames.EnumerationAttribute.toString(), enumerationattribute.toString());
		else
			getMendixObject().setValue(context, MemberNames.EnumerationAttribute.toString(), null);
	}
